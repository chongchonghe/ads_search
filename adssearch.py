...
>>> {0} -a 1955ApJ...121..161S""".format(os.path.basename(sys.argv[0])),
    ...
    parser.add_argument('-b', dest="bibliography", nargs=4,
                        help="Open a browser tab and direct to an ADS page "
    ...
    parser.add_argument('-ay', nargs='+',
                        ...
                        "\tads -ay Salpeter1955\n"
                        "\tads -ay Salpeter55.\n")
    parser.add_argument('-a', dest="article_identifier", nargs=1, type=str,
                        help="Add article to bibdesk. Accept bibcode/arxiv "
    ...
    parser.add_argument('-nob', action='store_true',
                        help="Toggle off 'open url in borwser'")
    parser.add_argument('-t', action='store_true',
                        help=("Run a test: 'ads -b 1955, ApJ, 121, 161'"))
...
def main():
    ...
    if parse.a is not None:
        sys.exit(os.system("echo ads2bibdesk " + parse.a))
        return
